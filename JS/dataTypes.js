...
// const myString = "42.5639";
// const myNumber = parseFloat(myString).toFixed(3);
...
// NaN is used to signal that a particular operation that was expected to return a number has failed to do so.
