...
// let appales = new Array("Bangladeshi", "kashmiri")
...
// let fruits=['apple','banana','orange','paka komla','dates']
...
//? 2: for in loop
//* for...in Loop: The for...in loop is used to iterate over the properties (including INDEX) of an object.
...
// fruits.forEach((currentElements,index) => {
...
// fruits.map((cuEle,index,arr)=>{
//   // console.log(cuEle);
//   return (`The Fruits Name is ${cuEle}`)   
// })



// const mapArr =fruits.map((cuEle,index,arr)=>{
//   // console.log(cuEle);
//   return (`The Fruits Name is ${cuEle}`)   
// })
...
// const numberss =[1,2,3,4,5,6,7,8,7,8,9]

// console.log(numberss.lastIndexOf(3,7));

//  lastIndexOf(3,7) ===> start from index 3 and find the index of 7 
...
// const numberss =[1,2,3,4,5,6,7,8,7,8,9]
// console.log(numberss.includes(51));
...
// const result=numbers.find((current)=>{
//   return current>3
// })
...
// const result=numbers.findIndex((current)=>{
//   return current>3
// })
...
// const result =numbers.filter((curr)=>{
//   return curr>5
// })
...
// const updatedNumbers= numbers.filter((curre)=>{
